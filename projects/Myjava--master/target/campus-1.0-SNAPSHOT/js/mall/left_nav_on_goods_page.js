        ...
        $('.detail_buy').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result == '2') {
                        layer.msg('您还未登录，请先登录', {icon: 5, time: 2000});
                    } else if (result == '1') {
                        layer.msg('加入购物车成功', {icon: 1, time: 2000});
                    } else if (result == '0') {
                        layer.msg('加入购物车失败', {icon: 2, time: 2000});
                    } else if (result == '3') {
                        layer.msg('商品库存不足', {icon: 2, time: 2000});
                    } else {
                        layer.msg('发生错误，请检查网络', {icon: 5, time: 2000});
                    }
                }
            });
        });
