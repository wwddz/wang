...
public class StringUtils {
  ...
  public boolean isPhone(String phone) {
    Pattern p = Pattern.compile("^(13[0-9]|14[5-9]|15[0-3,5-9]|16[2,5-7]|17[0-8]|18[0-9]|19[0-3,5-9])\\d{8}$");
  ...
  public ArrayList readTxt() throws IOException {
    ...
    String encoding = "GBK";
    File file = new File("D:\\Java\\projects\\mySSM-master\\src\\main\\resources\\txt\\all.txt");
