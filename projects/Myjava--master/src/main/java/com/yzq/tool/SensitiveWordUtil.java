...
public class SensitiveWordUtil {
  ...
  public static String dealTxt(String s) throws IOException {

    ClassPathResource classPathResource = new ClassPathResource("txt/all.txt");
    ...
    if (SensitiveWordUtil.contains(s)) {
      s = SensitiveWordUtil.replaceSensitiveWord(s, '*', SensitiveWordUtil.MinMatchTYpe);
    }
    return s;
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节。"
        + "然后网报【圣诞红包】网审平台我们的扮演加薇新跟随着主人公的喜红客联盟 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，然后感动就流泪，"
        + "难过就躺在某一个人的怀关键字里尽情的阐述心扉或者网报网审平台机店主V信一个贱人一杯红酒一部电影在夜 深人静的晚上，关上电话静静的发呆着。";
