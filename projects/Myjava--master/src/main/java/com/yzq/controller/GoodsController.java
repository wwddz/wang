...
import com.yzq.bean.ShopContextBean;
import com.yzq.bean.ShopInformationBean;
import com.yzq.bean.UserWantBean;
import com.yzq.pojo.*;
...
public class GoodsController {
  ...
  public String selectById(@RequestParam int id,
    ...
    try {
      ...
      UserInformation sailuserinformation = userInformationService.selectByPrimaryKey(shopInformation.getUid());
      model.addAttribute("sailuser", sailuserinformation.getUsername());
      model.addAttribute("contact",sailuserinformation.getContact());
